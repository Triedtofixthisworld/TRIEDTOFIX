...
show_banner()
print_slowly(' \x1b[41m\x1b[1;37m</> ᴛʜɪꜱ ɪɴꜱᴛᴀ ʜᴜɴᴛɪɴɢ ᴛᴏᴏʟ ʙʏ #ʀᴀᴅʜᴇʏ | @ꜱᴜɴʀᴀᴅʜᴇʏ• \x1b[0m\x1b[1;97m ')
time.sleep(1.5)
print("\x1b[1;39m━" * 60)
Token=input("\x1b[1;39mBOT TOKEN :  ")
print("\x1b[1;39m━" * 60)
ID=input('\x1b[1;39mCHAT ID : ') 
print("\x1b[1;39m━" * 60)
def pppp():
...
def rest(user):
  try:
    ...
    'Accept-Language': 'en-GB, en-US',
     'Cookie': 'mid=aEwLWQAEAAHIsU6iw7dleG8F8n_E; csrftoken=kCLEkUguulu003U5GPOUKftNy6Xa6C1z',
    'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
    ...
    data = {
    'signed_body': '0d067c2f86cac2c17d655631c9cec2402012fb0a329bcafb3b1f4c0bb56b1f1f.{"_csrftoken":"kCLEkUguulu003U5GPOUKftNy6Xa6C1z","adid":"0dfaf820-2748-4634-9365-c3d8c8011256","guid":"1f784431-2663-4db9-b624-86bd9ce1d084","device_id":"android-b93ddb37e983481c","query":"'+user+'"}',
...
def date(Id):
    try:
        ...
        if 1 < uid < 1279000:
            ...
            return 2019
        elif 21254029834 <= uid< 40000000000:
            return 2020
        elif 40000000000  <=uid< 60000000000:
            return 2021
        else:
            return "2022-2023"
    except Exception:
...
'''
    ...
    try:
        try:
            ...
            inline_keyboard=[[{'text':'SS','url':'http://t.me/boloradhey'},{'text':'CHANNEL','url':'https://t.me/+l_0wtXAN-vQ3MTJl'}]]
...
def check_on(email):
    ...
    data = {
        'signed_body': '0d067c2f86cac2c17d655631c9cec2402012fb0a329bcafb3b1f4c0bb56b1f1f.' + json.dumps({
            '_csrftoken': 'kCLEkUguulu003U5GPOUKftNy6Xa6C1z',
            'adid': uui,
            'guid': uui,
            'device_id': device_id,
            'query': email
